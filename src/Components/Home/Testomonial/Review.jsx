    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 border rounded-lg dark:border-gray-700">
                ...
                Credibility: Known for its reliability and adherence to journalistic standards, making it a trustworthy source for news.
                User-Friendly Interface: The website is easy to navigate, with well-organized sections and a clean layou.
                </p>
            ...
            <div className="p-8 bg-blue-500 border border-transparent rounded-lg dark:bg-blue-600">
                ...
                Multimedia Integration: The site offers a rich multimedia experience with videos, infographics, and live streams enhancing the news consumption experience.
                Global Reach: With correspondents worldwide, CNN covers a broad spectrum of international news.
                </p>
            ...
            <div className="p-8 border rounded-lg dark:border-gray-700">
                <p className="leading-loose text-gray-500 dark:text-gray-400">
                High-Quality Journalism: Renowned for its in-depth investigative journalism and well-written articles, The New York Times is a leader in quality news reporting.
Wide Range of Topics: Offers comprehensive coverage across various domains including politics, business, culture, science, and more.
                </p>
